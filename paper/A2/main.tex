...
competing interests.
During preparation, the authors used a large language model (Anthropic Claude)
to help write and edit the text, the LaTeX layout and the supporting code. The
authors reviewed all assisted content and take full responsibility.

\section{Compliance with Ethical Standards}
This study used only previously collected, publicly available recordings, under
the licence and terms of use of the ASVspoof, In-the-Wild and BRSpeech-DF
corpora, for non-commercial academic research. It involved no new recording and
no interaction with human participants, and required no ethical approval.
